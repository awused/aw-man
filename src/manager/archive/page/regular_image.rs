...
enum State {
    Unloaded,
    #[debug("Loading")]
    Loading(LoadFuture<UnscaledImage>),
    #[debug("Reloading {_1:?}")]
    Reloading(LoadFuture<UnscaledImage>, Image),
    #[debug("Reloading {_1:?}")]
    Scaling(DownscaleFuture<Image, ScalingParams>, UnscaledImage),
    #[debug("Loaded {_0:?}")]
